...
(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("vue"), require("date-fns")) : typeof define === "function" && define.amd ? define(["exports", "vue", "date-fns"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2.Vue3TableData = {}, global2.Vue, global2.dateFns));
})(this, function(exports2, vue, dateFns) {
  ...
  const _sfc_main$9 = {
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        ...
        ])) : __props.icon === "plus" ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3$4, [
          (vue.openBlock(), vue.createElementBlock("svg", _hoisted_4$4, _cache[1] || (_cache[1] = [
            vue.createElementVNode("path", {
        ...
        ])) : __props.icon === "radio-circle" ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_5$4, [
          (vue.openBlock(), vue.createElementBlock("svg", _hoisted_6$3, _cache[2] || (_cache[2] = [
        ...
        ])) : __props.icon === "radio-circle-selected" ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_7$3, [
          (vue.openBlock(), vue.createElementBlock("svg", _hoisted_8$3, _cache[3] || (_cache[3] = [
            vue.createElementVNode("circle", {
              cx: "9",
              cy: "9",
              r: "8.25",
        ...
        ])) : __props.icon === "large-row" ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_13$1, [
          (vue.openBlock(), vue.createElementBlock("svg", _hoisted_14$1, _cache[6] || (_cache[6] = [
            vue.createElementVNode("path", {
              "fill-rule": "evenodd",
              "clip-rule": "evenodd",
        ...
        ])) : __props.icon === "check" ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_15$1, [
          (vue.openBlock(), vue.createElementBlock("svg", _hoisted_16$1, _cache[7] || (_cache[7] = [
        ...
        ])) : __props.icon === "drag-indicator" ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_17$1, [
          (vue.openBlock(), vue.createElementBlock("svg", _hoisted_18$1, _cache[8] || (_cache[8] = [
            vue.createElementVNode("path", {
        ...
        ])) : __props.icon === "search" ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_19$1, [
          (vue.openBlock(), vue.createElementBlock("svg", _hoisted_20, _cache[9] || (_cache[9] = [
            vue.createElementVNode("path", {
        ...
        ])) : __props.icon === "columns" ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_21, [
          (vue.openBlock(), vue.createElementBlock("svg", _hoisted_22, _cache[10] || (_cache[10] = [
            vue.createElementVNode("path", {
        ...
        ])) : __props.icon === "settings" ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_23, [
          (vue.openBlock(), vue.createElementBlock("svg", _hoisted_24, _cache[11] || (_cache[11] = [
            vue.createElementVNode("path", {
  ...
  const _Column = class _Column {
    ...
    date(renderFormat = "dd.MM.yyyy", rawFormat = null) {
      ...
      this.withRenderer((isoStringDate) => isoStringDate ? dateFns.format(new Date(isoStringDate), renderFormat) : "");
      if (rawFormat)
        this.withMutator((value) => value ? dateFns.parse(value, rawFormat, /* @__PURE__ */ new Date()).toISOString() : null);
      return this;
    }
    dateTime(renderFormat = "dd.MM.yyyy HH:mm:ss", rawFormat = null) {
      return this.date(renderFormat, rawFormat);
    }
    money(currencyColumnKey = "currency", fractionDigits = 2, decimalSeparator = ",", thousandsSeparator = " ", prefixCurrency = false) {
      this.numeric();
      this.isComponent = false;
      this.withRenderer(
        (value, context) => {
    ...
    quantity(uomColumnKey = "uom", fractionDigits = 2, decimalSeparator = ",", thousandsSeparator = " ", prefixUom = false) {
      this.numeric();
      this.isComponent = false;
      this.withRenderer(
        (value, context) => {
  ...
  const _sfc_main$5 = {
    ...
    setup(__props, { emit: __emit }) {
      ...
      const visibleColumns = vue.computed(() => tableData.value.visibleColumns);
  ...
  const _sfc_main$4 = {
    ...
    setup(__props, { emit: __emit }) {
      ...
      vue.onUnmounted(() => document.body.style.overflow = "auto");
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", {
          onClick: _cache[0] || (_cache[0] = vue.withModifiers(($event) => emits2("close"), ["self"])),
          class: "modal"
        }, [
          vue.renderSlot(_ctx.$slots, "default")
        ]);
  ...
  const _sfc_main$3 = {
    ...
    setup(__props, { emit: __emit }) {
      const emits2 = __emit;
      const props2 = __props;
      let rowSize = vue.ref(props2.rowSizeValue);
      let digitsColor = vue.ref(props2.digitsColorValue);
      const rowSizes = {
        small: {
          "icon": "small-row",
      ...
      let showRowSizeSection = vue.ref(false);
      let showDigitsColorSection = vue.ref(false);
      function save() {
          ...
          default: vue.withCtx(() => [
            vue.createElementVNode("div", _hoisted_1$3, [
              vue.createElementVNode("div", {
                ...
                textContent: vue.toDisplayString(vue.unref(translateHelpers).getTranslate("style_settings_modal.title"))
              }, null, 8, _hoisted_2$3),
              vue.createElementVNode("div", {
                class: "settings-modal-description",
                textContent: vue.toDisplayString(vue.unref(translateHelpers).getTranslate("style_settings_modal.description"))
              }, null, 8, _hoisted_3$2),
              vue.createElementVNode("div", _hoisted_4$2, [
                vue.createElementVNode("div", _hoisted_5$2, [
                  vue.createElementVNode("div", {
                    class: "option-container",
                    onClick: _cache[0] || (_cache[0] = ($event) => vue.isRef(showRowSizeSection) ? showRowSizeSection.value = !vue.unref(showRowSizeSection) : showRowSizeSection = !vue.unref(showRowSizeSection))
                  }, [
                    vue.createElementVNode("div", {
                      class: "option-title",
                  ...
                  vue.unref(showRowSizeSection) ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_7$1, [
                    (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, vue.renderList(rowSizes, (option, key) => {
                ...
                _cache[3] || (_cache[3] = vue.createElementVNode("div", { class: "divider" }, null, -1)),
                vue.createElementVNode("div", _hoisted_11, [
                  vue.createElementVNode("div", {
                    class: "option-container",
                    onClick: _cache[1] || (_cache[1] = ($event) => vue.isRef(showDigitsColorSection) ? showDigitsColorSection.value = !vue.unref(showDigitsColorSection) : showDigitsColorSection = !vue.unref(showDigitsColorSection))
                  }, [
                    vue.createElementVNode("div", {
                      class: "option-title",
                  ...
                  vue.unref(showDigitsColorSection) ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_13, [
                    (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, vue.renderList(digitsColors, (label, key) => {
                      return vue.createElementVNode("div", {
                        class: "option-item-container",
                        ...
                        vue.createElementVNode("div", _hoisted_15, [
                          vue.createElementVNode("span", {
                            class: "option-item-title",
                            textContent: vue.toDisplayString(label)
                          }, null, 8, _hoisted_16)
                        ])
                      ], 8, _hoisted_14);
                    }), 64))
              ...
              vue.createElementVNode("div", _hoisted_17, [
                vue.createElementVNode("div", {
                  ...
                  textContent: vue.toDisplayString(vue.unref(translateHelpers).getTranslate("style_settings_modal.actions.cancel"))
                }, null, 8, _hoisted_18),
                vue.createElementVNode("div", {
                  class: "button button-confirm",
                  onClick: save,
                  textContent: vue.toDisplayString(vue.unref(translateHelpers).getTranslate("style_settings_modal.actions.save"))
                }, null, 8, _hoisted_19)
              ])
            ])
          ]),
    ...
    setup(__props, { emit: __emit }) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("label", {
          ...
          }, null, 8, _hoisted_4$1)) : vue.createCommentVNode("", true),
  ...
  function getRootInformation(tag) {
    ...
    return {
      transition,
      externalComponent,
      tag: externalComponent ? vue.resolveComponent(tag) : transition ? vue.TransitionGroup : tag
    };
  }
  ...
  function emit(evtName, evtData) {
    vue.nextTick(() => this.$emit(evtName.toLowerCase(), evtData));
  }
  ...
  const draggableComponent = vue.defineComponent({
    name: "draggable",
    inheritAttrs: false,
    props,
    emits,
    ...
    render() {
      try {
        ...
        return componentStructure.render(vue.h, attributes);
      } catch (err) {
        this.error = true;
        return vue.h("pre", { style: { color: "red" } }, err.stack);
      }
    },
    created() {
    ...
    methods: {
      ...
      emitChanges(evt) {
        vue.nextTick(() => this.$emit("change", evt));
      },
      alterList(onList) {
        if (this.list) {
          onList(this.list);
        ...
        return vue.openBlock(), vue.createBlock(_sfc_main$4, null, {
          default: vue.withCtx(() => [
            vue.createElementVNode("div", _hoisted_1$1, [
              vue.createElementVNode("div", {
                class: "settings-modal-title",
                textContent: vue.toDisplayString(vue.unref(translateHelpers).getTranslate("column_settings_modal.title"))
              }, null, 8, _hoisted_2$1),
              vue.createElementVNode("div", {
                class: "settings-modal-description",
                textContent: vue.toDisplayString(vue.unref(translateHelpers).getTranslate("column_settings_modal.description"))
              }, null, 8, _hoisted_3),
              vue.createElementVNode("div", _hoisted_4, [
                vue.createVNode(vue.unref(draggableComponent), {
                  modelValue: vue.unref(orderedColumns),
                  "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => vue.isRef(orderedColumns) ? orderedColumns.value = $event : orderedColumns = $event),
                  "item-key": "key",
                  animation: 300
                }, {
                  item: vue.withCtx(({ element: column }) => [
              ...
              vue.createElementVNode("div", _hoisted_6, [
                vue.createElementVNode("div", {
                  ...
                  textContent: vue.toDisplayString(vue.unref(translateHelpers).getTranslate("column_settings_modal.actions.cancel"))
                }, null, 8, _hoisted_7),
                vue.createElementVNode("div", {
                  class: "button button-confirm",
                  onClick: save,
                  textContent: vue.toDisplayString(vue.unref(translateHelpers).getTranslate("column_settings_modal.actions.save"))
                }, null, 8, _hoisted_8)
              ])
            ])
          ]),
  ...
  const _sfc_main = {
    ...
    setup(__props) {
      let rowSize = vue.ref("small");
      let digitsColor = vue.ref("black");
      let showStyleSettingsModal = vue.ref(false);
      let showColumnSettingsModal = vue.ref(false);
      let tableColumns = [];
      let isActiveSearch = vue.ref(false);
      let eventBus = useEventBus();
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", null, [
          vue.createElementVNode("div", _hoisted_1, [
            ...
            _cache[4] || (_cache[4] = vue.createElementVNode("div", { class: "divider" }, null, -1)),
